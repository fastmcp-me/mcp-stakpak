			...
			.array(
				z.object({
					content: z
						.string()
						.describe(
							"The actual code/text content that was selected"
						),
					document_uri: z
						.string()
						.describe(
							"File path or URI where the selection is from"
						),
					language: z
						.string()
						.describe(
							"Programming language or file type of the selection"
						),
					start_row: z
						.number()
						.describe("Starting line number of selection"),
					start_column: z
						.number()
						.describe("Starting column number of selection"),
					end_row: z
						.number()
						.describe("Ending line number of selection"),
					end_column: z
						.number()
						.describe("Ending column number of selection"),
					start_byte: z
						.number()
						.describe("Starting byte offset of selection"),
					end_byte: z
						.number()
						.describe("Ending byte offset of selection")
				})
			)
			.optional()
			.describe(
				"Array of code selections to use as context for generation"
			),
